...
antlrcpp::Any SA_fugue_sqlTranslator::visitDescribeColName(fugue_sqlParser::DescribeColNameContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_identifier", static_cast<void*>(ctx->_identifier)}
    };
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, DescribeColNameContext_cls, labels, 1);
    return py_ctx;
}
...
antlrcpp::Any SA_fugue_sqlTranslator::visitQueryOrganization(fugue_sqlParser::QueryOrganizationContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_sortItem", static_cast<void*>(ctx->_sortItem)},
//        {"_expression", static_cast<void*>(ctx->_expression)},
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, QueryOrganizationContext_cls, labels, 3);
    return py_ctx;
}
...
antlrcpp::Any SA_fugue_sqlTranslator::visitHint(fugue_sqlParser::HintContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_hintStatement", static_cast<void*>(ctx->_hintStatement)}
    };
    if(!HintContext_cls) HintContext_cls = PyObject_GetAttrString(translator->parser_cls, "HintContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, HintContext_cls, labels, 1);
    return py_ctx;
}
...
//        {"_primaryExpression", static_cast<void*>(ctx->_primaryExpression)}
    };
    if(!HintStatementContext_cls) HintStatementContext_cls = PyObject_GetAttrString(translator->parser_cls, "HintStatementContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, HintStatementContext_cls, labels, 2);
    return py_ctx;
}
...
//        {"_expression", static_cast<void*>(ctx->_expression)},
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, AggregationClauseContext_cls, labels, 2);
    return py_ctx;
}
...
//        {"_pivotValue", static_cast<void*>(ctx->_pivotValue)}
    };
    if(!PivotClauseContext_cls) PivotClauseContext_cls = PyObject_GetAttrString(translator->parser_cls, "PivotClauseContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, PivotClauseContext_cls, labels, 2);
    return py_ctx;
}
...
//        {"_identifier", static_cast<void*>(ctx->_identifier)}
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, PivotColumnContext_cls, labels, 1);
    return py_ctx;
}
...
//        {"_identifier", static_cast<void*>(ctx->_identifier)}
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, LateralViewContext_cls, labels, 2);
    return py_ctx;
}
...
antlrcpp::Any SA_fugue_sqlTranslator::visitIdentifierSeq(fugue_sqlParser::IdentifierSeqContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_errorCapturingIdentifier", static_cast<void*>(ctx->_errorCapturingIdentifier)}
    };
    if(!IdentifierSeqContext_cls) IdentifierSeqContext_cls = PyObject_GetAttrString(translator->parser_cls, "IdentifierSeqContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, IdentifierSeqContext_cls, labels, 1);
    return py_ctx;
}
...
//        {"_errorCapturingIdentifier", static_cast<void*>(ctx->_errorCapturingIdentifier)}
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, MultipartIdentifierContext_cls, labels, 1);
    return py_ctx;
}
...
antlrcpp::Any SA_fugue_sqlTranslator::visitTransformList(fugue_sqlParser::TransformListContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_transform", static_cast<void*>(ctx->_transform)}
    };
    if(!TransformListContext_cls) TransformListContext_cls = PyObject_GetAttrString(translator->parser_cls, "TransformListContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, TransformListContext_cls, labels, 1);
    return py_ctx;
}
...
//        {"_transformArgument", static_cast<void*>(ctx->_transformArgument)}
    };
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, ApplyTransformContext_cls, labels, 2);
    return py_ctx;
}
...
antlrcpp::Any SA_fugue_sqlTranslator::visitStruct(fugue_sqlParser::StructContext *ctx){
    speedy_antlr::LabelMap labels[] = {
//        {"_namedExpression", static_cast<void*>(ctx->_namedExpression)}
    };
    if(!StructContext_cls) StructContext_cls = PyObject_GetAttrString(translator->parser_cls, "StructContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, StructContext_cls, labels, 1);
    return py_ctx;
}
...
//        {"_expression", static_cast<void*>(ctx->_expression)},
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, FunctionCallContext_cls, labels, 2);
    return py_ctx;
}
...
//        {"_expression", static_cast<void*>(ctx->_expression)}
    ...
    PyObject *py_ctx = translator->convert_ctx(this, ctx, WindowDefContext_cls, labels, 1);
    return py_ctx;
}
